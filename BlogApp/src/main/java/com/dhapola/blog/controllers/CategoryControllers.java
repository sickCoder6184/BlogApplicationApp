...
public class CategoryControllers {
	...
	public ResponseEntity<ApiResponse> delteAllUser() {
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("All User deleted Successfully", true, LocalTime.now()),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<ApiResponse> deleteCategory(@PathVariable Integer catId) {
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("category is deleted", true, LocalTime.now()),
				HttpStatus.OK);
	}
